...
# v2.0.46 Odoo Store Submission Package: adds polished static description page, screenshot image assets, final OPL-1/store metadata, and submission-readiness documentation.
